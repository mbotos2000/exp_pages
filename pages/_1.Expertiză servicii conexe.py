...
if st.session_state['file']!=None or st.session_state['cond']!=None:
  ...
  #(docx_files["template.docx"],docx_files["template_fREL.docx"],docx_files["template_fGEO.docx"],
    ...
    if (st.session_state.step >= 8):
      ...
      for key in ["val_inc_nd","val_ET","val_bet","val_bet_2","val_geo","val_dezveliri","val_a_3d","val_a_rel", "val_et_finisaje","val_rel_struct","val_et_actualizat",
                   "tarif_et","val_rel",
                     "val_dezv_8"]:
       try:
         st.session_state[key]=float_to_eu(st.session_state[key])
       except:
		   pass
